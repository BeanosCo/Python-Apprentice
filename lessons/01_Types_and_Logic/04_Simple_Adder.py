...
num1 = simpledialog.askfloat("Your Addition", "What is the first number?")

# Ask the user for the second number

num2 = simpledialog.askfloat("Your Addition", "What is the second number?")

# Display the sum of the two numbers 

messagebox.showinfo('Your Addition', num1 + num2)
